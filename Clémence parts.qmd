...
```{r}
Temperature_exposure<-read_excel(here("raw_data","OECD.ENV.EPI,DSD_ECH@EXT_TEMP_H,2.0,filtered,2025-11-21 14-59-03.xlsx"), skip=6)
...
```{r}
EPS_index <- read_excel(here("raw_data","OECD.ECO.MAD,DSD_EPS@DF_EPS,1.0,filtered,2025-11-19 13-27-34.xlsx"), skip=6)
...
```{r}
RD_share_of_GDP <- read_excel(here("raw_data","OECD.STI.STP,DSD_MSTI@DF_MSTI,,filtered,2025-11-21 21-55-03.xlsx"),skip=3)
...
unused_overall   # jamais vus nulle part
used_overall     # effectivement présents dans au moins un jeu de données
